...
export class AddMetadataToUploadSession1759486519652
  implements MigrationInterface
{
  name = 'AddMetadataToUploadSession1759486519652';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "upload_session" ADD "metadata" jsonb`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."company_invitations_status_enum" AS ENUM('pending', 'accepted', 'expired', 'revoked')`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."company_invitations_status_enum_old" AS ENUM('pending', 'accepted', 'declined', 'expired')`,
    );
    await queryRunner.query(
      `ALTER TABLE "company_invitations" ALTER COLUMN "status" DROP DEFAULT`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "upload_session" DROP COLUMN "metadata"`,
    );
    await queryRunner.query(
      `ALTER TABLE "company_invitations" ADD "acceptedAt" TIMESTAMP`,
    );
