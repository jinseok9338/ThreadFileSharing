...
function testChatroomJoin() {
  console.log("💬 채팅방 조인 테스트 (권한 에러 예상)...");
...
function testThreadJoin() {
  console.log("🧵 스레드 조인 테스트 (권한 에러 예상)...");
...
// 업로드 세션 조인 테스트 (권한 에러 예상)
function testUploadSessionJoin() {
  console.log("📁 업로드 세션 조인 테스트 (권한 에러 예상)...");
...
function testChatMessages() {
  console.log("💭 채팅 메시지 테스트 (권한 에러 예상)...");
...
// 타이핑 인디케이터 테스트 (권한 에러 예상)
function testTypingIndicators() {
  console.log("⌨️ 타이핑 인디케이터 테스트 (권한 에러 예상)...");
